...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/90 backdrop-blur-2xl p-6 shadow-xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
