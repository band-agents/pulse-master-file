...
const DEMO_MEMBERS: Member[] = [
  { id: "1", user_id: "u1", role: "owner", department: "cardiology", display_name: "Dr. Hala Al-Rasheed", status: "active", email: "h.rasheed@almadinah.sa", phone: "+966-55-410-0001", joined_at: "2022-03-01", last_active: "Just now", login_count: 812, two_factor: true, branch_access: ["br-01", "br-02"] },
  { id: "2", user_id: "u2", role: "admin", department: "administration", display_name: "System Administrator", status: "active", email: "it.admin@almadinah.sa", phone: "+966-55-410-0100", joined_at: "2022-03-01", last_active: "12 min ago", login_count: 604, two_factor: true, branch_access: ["br-01", "br-02", "br-03", "br-04"] },
  { id: "3", user_id: "u3", role: "surgeon", department: "surgery", display_name: "Dr. Faisal Al-Harthy", status: "active", email: "f.harthy@almadinah.sa", phone: "+966-55-410-0002", joined_at: "2022-08-14", last_active: "40 min ago", login_count: 388, two_factor: true, branch_access: ["br-01"] },
  { id: "4", user_id: "u4", role: "physician", department: "cardiology", display_name: "Dr. Maha Al-Sanea", status: "active", email: "m.sanea@almadinah.sa", phone: "+966-55-410-0004", joined_at: "2024-09-02", last_active: "1 hour ago", login_count: 211, two_factor: false, branch_access: ["br-01"] },
  { id: "5", user_id: "u5", role: "resident", department: "emergency", display_name: "Dr. Rakan Al-Shammari", status: "active", email: "r.shammari@almadinah.sa", phone: "+966-55-410-0081", joined_at: "2026-02-10", last_active: "8 min ago", login_count: 96, two_factor: false, branch_access: ["br-01"] },
  { id: "6", user_id: "u6", role: "charge_nurse", department: "icu", display_name: "Nurse Aisha Al-Dakhil", status: "active", email: "a.dakhil@almadinah.sa", phone: "+966-55-410-0005", joined_at: "2023-06-20", last_active: "3 min ago", login_count: 540, two_factor: true, branch_access: ["br-01"] },
  { id: "7", user_id: "u7", role: "nurse", department: "emergency", display_name: "Nurse Khalid Al-Ruwais", status: "active", email: "k.ruwais@almadinah.sa", phone: "+966-55-410-0015", joined_at: "2024-05-30", last_active: "Just now", login_count: 421, two_factor: false, branch_access: ["br-01"] },
  { id: "8", user_id: "u8", role: "pharmacist", department: "pharmacy", display_name: "Dr. Huda Al-Qarni", status: "active", email: "h.qarni@almadinah.sa", phone: "+966-55-410-0012", joined_at: "2023-11-05", last_active: "25 min ago", login_count: 367, two_factor: true, branch_access: ["br-01", "br-04"] },
  { id: "9", user_id: "u9", role: "lab_technician", department: "laboratory", display_name: "Dr. Salma Al-Hazmi", status: "active", email: "s.hazmi@almadinah.sa", phone: "+966-55-410-0010", joined_at: "2023-04-18", last_active: "2 hours ago", login_count: 298, two_factor: false, branch_access: ["br-01"] },
  { id: "10", user_id: "u10", role: "radiologist", department: "radiology", display_name: "Dr. Tariq Al-Balawi", status: "active", email: "t.balawi@almadinah.sa", phone: "+966-55-410-0011", joined_at: "2023-04-18", last_active: "Today", login_count: 264, two_factor: true, branch_access: ["br-01"] },
  { id: "11", user_id: "u11", role: "receptionist", department: "administration", display_name: "Munira Al-Ajmi", status: "active", email: "m.ajmi@almadinah.sa", phone: "+966-55-410-0101", joined_at: "2025-01-12", last_active: "6 min ago", login_count: 189, two_factor: false, branch_access: ["br-02"] },
  { id: "12", user_id: "u12", role: "billing_officer", department: "revenue_cycle", display_name: "Noura Al-Mansouri", status: "active", email: "n.mansouri@almadinah.sa", phone: "+966-55-410-0042", joined_at: "2025-07-21", last_active: "Yesterday", login_count: 143, two_factor: true, branch_access: ["br-01", "br-02"] },
  { id: "13", user_id: "u13", role: "biomed_technician", department: "biomedical", display_name: "Eng. Tariq Al-Sulami", status: "active", email: "t.sulami@almadinah.sa", phone: "+966-55-410-0032", joined_at: "2025-04-17", last_active: "3 days ago", login_count: 71, two_factor: false, branch_access: ["br-01", "br-04"] },
  { id: "14", user_id: "u14", role: "viewer", department: "icu", display_name: "Nurse Mona Al-Faraj", status: "inactive", email: "m.faraj@almadinah.sa", phone: "+966-55-410-0091", joined_at: "2025-03-09", last_active: "5 weeks ago", login_count: 88, two_factor: false, branch_access: [] },
];

const DEMO_INVITES: PendingInvite[] = [
  { id: "inv-1", email: "r.suwailem@almadinah.sa", name: "Dr. Rana Al-Suwailem", role: "physician", department: "paediatrics", sent_at: "2 hours ago", status: "pending" },
  { id: "inv-2", email: "y.habib@almadinah.sa", name: "Dr. Yasser Al-Habib (locum)", role: "physician", department: "theatres", sent_at: "1 day ago", status: "pending" },
                    ...
                    <div className="p-5 rounded-xl border border-border/40 bg-muted/20 space-y-3">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div>
                          ...
                          <input type="email" value={createForm.email} onChange={e => setCreateForm(p => ({ ...p, email: e.target.value }))} className={inputCls} placeholder="name@almadinah.sa" />
                        </div>
                        <div>
            ...
            <motion.div key="audit" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
              ...
              <div className="space-y-0">
                {[
                  ...
                  { time: "Aug 21, 2:30 PM", user: "Dr. Hala Al-Rasheed", action: ar ? "إرسال دعوة" : "Sent invitation", target: "r.suwailem@almadinah.sa", detail: ar ? "الدور: طبيب، القسم: الأطفال" : "Role: physician, Department: Paediatrics", icon: Send, color: "text-brand-ink" },
